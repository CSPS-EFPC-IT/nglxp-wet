...
return [
    ...
    "We have archived this page and will not be updating it." => "Nous avons archivé cette page et elle ne sera plus mise à jour.",
    "You can use it for research or reference." => "Vous pouvez la consulter à des fins de recherche ou à titre de référence.",
    "Close overlay" => "Fermer la fenêtre superposée",
    "GCcampus login" => "Se connecter à GCcampus",

    // Ajax submenu
    "/dist/site/ajax/sitemenu-v5-en.html" => "/dist/site/ajax/sitemenu-v5-fr.html",
    ...
    // Calendar
    "Learning links" => "Liens d'apprentissage",
    "Courses" => "Cours",
    "Events" => "Événements",
    "Videos on demand" => "Vidéos sur demande",
    "This page is a <b>beta release</b> and only displays upcoming offerings until <b>March 31, 2020</b>. <a href=\"#comments\">Let us know what you think of it</a>." => "Cette page est une <b>version bêta</b> et affiche les offres à venir jusqu'au <b>31 mars 2020</b>. <a href=\"#commentaires\">Dites-nous ce que vous en pensez</a>",
];
